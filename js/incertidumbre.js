...
function calcular() {
    ...
    contenedorResultados.innerHTML = "<p>∆𝒑 = " + parteDecimalAp + "x 10 <sup> " + exponenteAp + "</sup> kg*m/s </p>" +
...
function mostrarDetalle() {
    var detalles = "<p><strong>La formula de Principio de incertidumbre es: </strong> ∆𝑝=𝑚∗∆𝑢</p>" +
        ...
        "<p> ∆𝑝 = (" + masaInput + " kg) * (" + parteDecimalIndeterminacion + " x 10 <sup>" + exponenteIndeterminacion + "</sup> m/s)</p>" +
        "<p> ∆𝑝 = " + parteDecimalAp + " x 10 <sup>" + exponenteAp + "</sup> kg m/s </p><br>" +
        ...
        "<p> ∆𝑥 ≥ ℎ / (4π * ∆𝑝)</p>" + 
        "<p> ∆𝑥 ≥ (" + parteDecimalConstantePlanck + " x 10 <sup>" + exponenteConstantePlanck + "</sup> J s) / (4π * " + parteDecimalAp + " x 10 <sup>" + exponenteAp + "</sup> kg m/s)</p>" +
